...
const courseContent = [
    {
        ...
        videoUrl: "https://www.youtube.com/embed/LWGSwfchz_A?rel=0&modestbranding=1&t=" + Date.now(), // Updated working yoga/meditation video
    },
    {
        day: 2,
        ...
        <div className="flex flex-1">
            <div className="common-container">
                <div className="max-w-5xl flex-1 items-center justify-start gap-3 flex-col md:justify-center w-full">
                                                ...
                                                <div className="flex flex-row">
                                                    ...
                                                    <div className="w-1/3">
                                                        <div
                                                            ...
                                                            onClick={() => {
                                                                setIsModalOpen(true);
                                                                setModalVideoUrl("https://www.youtube.com/embed/LWGSwfchz_A?autoplay=1&rel=0");
                                                            }}
                                                        >
                    ...
                    <section className="flex flex-col gap-8 w-full">
                        {/* Payment CTA (show after trial ends) */}
                        {(!user.isTrialActive || currentDay >= 7) && !user.hasPaid && (
